...
**Histogram** A histogram is a representation of *the distribution* of a single variable, hence the `aes()` will only have the `x`. The histogram layer is translated via the function `geom_histogram`.
