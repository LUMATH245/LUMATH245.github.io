...
We’ve learned how to compute summary statistics like mean and max for entire data frames. However, this doesn’t always reveal the full story, as we are viewing all at the top level. 
Consider now variables that share common characteristics, such as a person’s city or a car’s engine type. We can group data by these characteristics, and when we do so patterns begin to emerge from the numerical chaos. 
