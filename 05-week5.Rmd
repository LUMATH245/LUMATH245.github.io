...
-   The plot should have three subplots, one for each frequency ($\frac{1}{2}$, 1, and 2).
    Each subplot should contain both the sine and cosine functions of that frequency.

-   Use different colours for each curve (sine or cosine) within the facets.

-   Avoid a `for` loop or computing everything by hand.
    TIP: Use `map` and `reduce` to generate the dataframes and combine them.
