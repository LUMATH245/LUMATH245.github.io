...
Let's create a scatterplot of `mpg` against `hp` (horsepower).
...
We can introduce higher dimensions by mapping additional variables to other aesthetics like color.
