...
In this exercise, we will further explore the `mtcars` dataset. The goal is to create a new variable, efficiency, and summarise the data to produce meaningful statistics. You should:
