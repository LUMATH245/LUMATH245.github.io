...
As mentioned earlier, R has changed a lot over the recent years, including more and more tools
for functional programming, fast data manipulation, exploration, analysis and plotting.

The `tidyverse` includes a wide range of packages that improve R for scientific computing. 
We have already seen one of those, in the past week: the `purrr` library. However, there's much more, other of the core packages in the `tidyverse` include `ggplot2` for data visualization, `dplyr` for
