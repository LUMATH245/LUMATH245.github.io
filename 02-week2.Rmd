...
As you can see, the square brackets `[ ]` are used to access the elements of the array by using their index, and the equal sign `=` is used to assign new values to them
...
# small hint: python does not convert the type of vector automatically, the dtype 
# argument is needed to ensure the vector can contain both integers and strings.
# remove the dtype argument from the first line and see what happens
```
