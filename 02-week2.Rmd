...
# Comparing two no. with decimals
3.14 == 3.14
...
decimal places can make two numbers unequal. Numbers with decimal places and fractional numbers, in computing are called *doubles*. Try adding more decimals to
