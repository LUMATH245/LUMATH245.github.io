...
We explained how R, in the recent years, has been undergoing one of the most beautiful transformations of the languages. In general, inexperienced R users tend to drift away from the language as it's seen as inelegant, ugly, or "hacky". Well, that was prior to the `tidyverse` revolution. What if I tell you that you can code the above `generic_fizzbuzz` of the exercise in Section \@ref(generic-fizzbuzz) in a very compact way?
