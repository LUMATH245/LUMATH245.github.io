...
-   Then, in a cycle, update this vector with the cumulative sum of the elements of the input vector
    ...
    -     The first element should be the same first element of the input vector
...
-   Compare the output of `my_cusum` with the built in function `cumsum` (R) or numpy's `np.cumsum`.
