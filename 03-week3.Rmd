...
Also, the computation of the full Fibonacci sequence is encapsulated in its own function, `compute_fibonacci`! This makes the code more organized and easier to understand, and less prone to errors due to variables defined elsewhere **as it does not touch global state**. 

For this reason, you can easily **reuse** the `compute_fibonacci` function in other parts of your code or even in different programs! For instance, this function might turn out to be useful in the next exercise. 
